class Score
  ...
  def is_it_three_pairs?(scoring_dice)
  ...
  def is_it_three_of_a_kind?(scoring_dice)
    (scoring_dice[0..2] && scoring_dice[0..2].length == 3 && scoring_dice[1..2].all? { |scoring_die| scoring_die == scoring_dice[0] }) ||
  ...
  def is_it_four_of_a_kind?(scoring_dice)
  ...
  def is_it_five_of_a_kind?(scoring_dice)
  ...
  def score(scoring_dice, game_instance)
    ...
    three_pairs = is_it_three_pairs?(scoring_dice)
    three_of_a_kind = is_it_three_of_a_kind?(scoring_dice)
    four_of_a_kind = is_it_four_of_a_kind?(scoring_dice)
    five_of_a_kind = is_it_five_of_a_kind?(scoring_dice)
    six_of_a_kind = is_six_of_a_kind?(scoring_dice)
    tally_score = 0
    ...
    game_instance.available_dice += rejected_dice.length
    tally_score
  end
end